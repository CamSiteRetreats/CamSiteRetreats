...
async function onRequest2(context) {
  ...
  try {
    ...
    if (request.method === "POST" && action === "search") {
      ...
      const normalizeDob = /* @__PURE__ */ __name((val) => {
        if (!val) return "";
      ...
      const normalizeGender = /* @__PURE__ */ __name((g) => {
        if (!g) return "Kh\xE1c";
...
// ../.wrangler/tmp/pages-7NadH6/functionsRoutes-0.19092451325675674.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-0OdiYO/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-0OdiYO/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.628882266781114.mjs.map
