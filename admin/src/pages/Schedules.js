...
export const afterRender = () => {
                ...
                <div class="glass-panel p-5 border-l-4 border-csr-orange hover:shadow-md transition-all duration-200" data-schedule-id="${item.id}">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div class="flex gap-2 shrink-0">
                            ...
                            <button class="sch-details-btn bg-csr-orange hover:opacity-90 text-white rounded-lg px-4 py-2.5 text-sm font-medium transition-all flex items-center gap-2" data-tour="${item.tour_name}" data-date="${item.start_date}" title="Xem Danh Sách Đoàn">
    ...
    const handleCardAction = async (e) => {
        ...
        if (detailsBtn) {
            ...
            const url = `/admin/roster?tour=${encodeURIComponent(tourName)}&date=${encodeURIComponent(safeDate)}`;
