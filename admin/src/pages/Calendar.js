...
export const afterRender = () => {
    ...
    const loadData = async () => {
        // Render lưới tháng ngay (không chờ API)
        renderCalendar();
    ...
    const renderCalendar = () => {
        ...
        // Build map: YYYY-MM-DD => schedules[]
        const dayMap = {};
        filtered.forEach(s => {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            cells += `
            <div class="min-h-[80px] border-r border-b border-gray-100 p-1 ${isToday ? 'bg-csr-orange/5 ring-2 ring-inset ring-csr-orange/30' : 'hover:bg-gray-50'} transition-colors">
