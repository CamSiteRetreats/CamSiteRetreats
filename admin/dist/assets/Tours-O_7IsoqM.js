import{S as y,H as x}from"./Header-BkqStZbn.js";const I=()=>`
                ...
                <tr class="hover:bg-gray-50 transition-colors group" data-tour-id="${e.id}">
                    ...
                    <td class="p-4 text-right">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <a href="/admin/tour-settings?id=${e.id}" data-link class="p-2 text-gray-400 hover:text-orange-500 hover:bg-orange-50 rounded-lg transition-colors inline-flex" title="Thiết lập đăng ký">
